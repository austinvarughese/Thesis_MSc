...
\documentclass[twoside, lineno, fontset=fira-newtxsf]{mitthesis}% fontset=libertinus, fontset=lmodern, fontset=lucida, 
%						fontset=newtx, fontset=newtx-sans-text,  
...
\hypersetup{%
	pdfsubject={The use of behavioural kinematics to decode affective dynamics in naturalistic paradigms},
...
\Author{Austin Varughese}{Cognitive Brain Dynamics Laboratory}
...
\Degree{Master's of Neuroscience}{Cognitive Brain Dynamics Laboratory}
%\Degree{Master of Science in Physics}{}
%\Degree{Bachelor of Science in Mechanical Engineering}{Department of Mechanical Engineering}

% If there is more than one supervisor, use the \Supervisor command for each.
\Supervisor{Arpan Banerjee}{Professor Scientist VII}
