...
\usepackage[style = apa, citestyle=authoryear, maxnames = 2, bibstyle=numeric, sorting=nyt]{biblatex}
...
\addbibresource{thesis-references.bib}%% <== change to YOUR bib file <= CHANGE
...
\hypersetup{%
	pdfsubject={Master's thesis of Austin Varughese},
	% Change this to briefly state topic of your thesis 
% 
	pdfkeywords={National Brain Research Centre, NBRC},
...
%	
	pdfcontactemail={austinvarughese@gmail.com},
...
\title{The use of behavioural kinematics to decode affective dynamics in naturalistic paradigms}
...
\Author{Austin Varughese}{Computational Brain Dynamics Laboratory}
...
\Degree{Master's of Science in Neurosciences}{Cognitive Brain Dynamics Laboratory}
%\Degree{Master of Science in Physics}{}
%\Degree{Bachelor of Science in Mechanical Engineering}{Department of Mechanical Engineering}

% If there is more than one supervisor, use the \Supervisor command for each.
\Supervisor{Prof. Dr. Arpan Banerjee}{Scientist VII}
...
\newgeometry{top=1in, bottom=1in, inner=1in, outer=1in, bindingoffset = 0.5in, headsep=12pt, footskip=0.5in, heightrounded}
...
\includepdf[pages=-]{AustinV_Certificate.pdf}

\includepdf[pages=-]{PlagriasmCertificate.pdf}

\include{certificate_author}
